...
const Bar1 = ({height}) =>{
    const elem= <div className={`bottom-0 z-0   absolute bg-[#98D89E] mb-1.5 mx-1 rounded w-5 md:w-8 lg:w-10`} style={{top:height}}></div>
    
    return elem
}
const Bar2 = ({height}) =>{
    const elem= <div className={`bottom-0  z-0 left-6 md:left-9  lg:left-12 absolute bg-[#EE8484] mb-1.5 mx-1 rounded w-5 md:w-8 lg:w-10  `} style={{top:height}}></div>
...
const Barchart = ({data}) => {
  ...
  return (
    <div className='w-[92%] md:w-[91%] lg:w-[97%] py-3 px-4 bg-white border-2 border-[#E0E0E0] border-solid rounded-2xl shadow-[3px_4px_11px_0px_#62626226] ml-4 md:ml-9 lg:ml-2'>
        {/* chart shimmer */}
        {/* <Barchart_shimmer></Barchart_shimmer> */}
        <div className='flex justify-between mr-8 font-montserrat ml-4 mt-2'>
            ...
            <div className='flex items-end font-lato text-sm'>
        ...
        <div className='relative font-lato mt-3'>
            ...
            <div className='relative flex items-end w-36 md:w-auto lg:w-auto left-32 md:left-8 lg:left-0 z-0 h-[17rem] justify-evenly'>
